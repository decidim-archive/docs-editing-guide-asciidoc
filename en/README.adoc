...
:_title: Decidim Documentation Editing Guide
...
// below.
:authors: Guillem Marpons Ucero

// OPTIONAL. See this field description in section "Authorship criteria ..."
// below.
:_contributors: Carles Muiños
...
:_dochistory: This document adapts https://github.com/decidim/docs-editing-guide[a previous Guide by Carles Muiños] to the use of Asciidoctor.
